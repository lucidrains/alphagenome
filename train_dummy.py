...
if platform.system() == 'Darwin' and platform.machine() == 'arm64':
    ...
    print("ℹ️ Not Apple Silicon — skipping MPS fallback.")
...
def main():
    ...
    # Setup accelerator for distributed training with find_unused_parameters
    #from accelerate.utils import DistributedDataParallelKwargs
    ...
    accelerator = Accelerator(
        ...
        kwargs_handlers=[ddp_kwargs]  # 使用正确的参数处理器
    )
